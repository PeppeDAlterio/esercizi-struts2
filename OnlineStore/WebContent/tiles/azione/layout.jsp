...
<!-- Logo -->
<tr class="layoutTr">
<th class="layoutTh" colspan="5"><tiles:insertAttribute name="logo" /></th>
</tr>
...
<!-- Body -->
<tr class="layoutTr">
<td class="layoutTd" style="border-left: 1px #C97B32 solid; border-right: 1px #C97B32 solid; text-align: center; padding: 10px; padding-bottom: 20px;"><tiles:insertAttribute name="body" /></td>
</tr>
